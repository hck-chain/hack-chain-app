...
const EditEducatorProfile = () => {
  ...
  const handleSaveIntent = () => {
    if (isSaving) return;
    if (!isValidUrl(websiteUrl) || !isValidUrl(linkedinUrl) || !isValidUrl(twitterUrl)) {
      toast({
      ...
      <div className="min-h-screen font-body" style={{ color: P.textPrimary }}>
        ...
        >
          ...
          <SectionCard
            ...
            description={t('editProfile.bioPlaceholder')}
            trailing={
              <span
          ...
          <SectionCard label={t('editProfile.accountSection')}>
            <div>
              <AccountRow label={t('editProfile.roleLabel')} value={t('editProfile.educatorRole')} />
              <AccountRow
