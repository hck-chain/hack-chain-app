...
function WalletChip({ address }: { address: string }) {
  ...
  return (
    ...
    >
      {copied ? (
        <BadgeCheck size={11} style={{ color: P.accent }} aria-hidden />
      ) : (
        <img
...
const TalentProfile = () => {
  ...
  const {
    ...
    isPending,
    isError,
  } = useTalentProfile(wallet?.toLowerCase());
  ...
  const hasAnyLinks =
    !!talent?.github_url || !!talent?.linkedin_url || !!talent?.twitter_url;
  const hasKnowledgeAreas = talent?.knowledge_areas.length ?? 0;
        ...
        >
          ...
          <header className="mb-8 flex items-center justify-between">
            <Button
              ...
              style={{ color: P.textSecondary, minHeight: 44 }}
            >
            ...
            <div className="flex items-center gap-3">
              {isOwnProfile && (
                ...
                >
                  {t("talentProfile.editButton", "Editar perfil")}
                </Button>
              )}
            </div>
          </header>
          ...
          {talent && !isPending && (
            <motion.div
              ...
              variants={{
                hidden: {},
                visible: {
                  transition: prefersReduced ? {} : { staggerChildren: 0.06 },
                },
              }}
            >
                  ...
                  <div className="relative px-6 sm:px-7 pb-6 sm:pb-7 -mt-10 sm:-mt-12">
                    <div className="flex flex-col sm:flex-row gap-5 sm:items-end">
                      ...
                      >
                        {talent.photo_url ? (
                          ...
                          >
                            {initials(talent.name, talent.lastname)}
                          </AvatarFallback>
                        )}
                      </Avatar>
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-5">
                      {talent.walletAddress && (
                        <WalletChip address={talent.walletAddress} />
                      )}
                      <div
                      ...
                      <ShareButton
                        ...
                        shareText={t(
                          `Check out ${displayName}'s profile on HackChain`,
                        )}
                        ...
                        variant="outline"
                        onShare={() =>
                          api.registerProfileShare(talent.walletAddress)
                        }
                      />
                    </div>
                  </div>
              ...
              >
                <Section label={t("talentProfile.aboutYouSection")}>
                  {talent.bio ? (
                    <p
              ...
              {hasKnowledgeAreas > 0 && (
                ...
                >
                  <Section label={t("talentProfile.expertieSection")}>
                    ...
                    <div className="space-y-2.5">
                      {talent.github_url && (
                        <SocialLink
                          ...
                          label={t("talentProfile.gitLabel")}
                      ...
                      {talent.instagram_url && (
                        <SocialLink
                          ...
                          label={t("talentProfile.instagramLabel")}
                          url={talent.instagram_url}
                        />
                      )}
                    </div>
                  </Section>
                ...
                >
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <a
                        href={explorerUrl(talent.walletAddress)}
                        target="_blank"
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">
                          {t("talentProfile.viewOnExplorer")}
                        </span>
                      </a>
                    </div>
                  </div>
