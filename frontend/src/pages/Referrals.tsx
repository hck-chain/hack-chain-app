  ...
  return (
    <Layout>
      <div className="min-h-screen relative font-body text-slate-200 px-4 sm:px-6 md:px-12 pt-12 pb-20 max-w-[1200px] mx-auto">
        ...
        >
          {/* Header */}
          <header className="mb-14 grid grid-cols-1 lg:grid-cols-3 items-start md:items-center gap-6">
          ...
          {!STAKING_ENABLED && (
            <div className="relative overflow-hidden bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl mb-8">
          ...
          {isLoading ? (
            ...
            <>
              <div className="grid md:grid-cols-12 gap-8 items-start">
                {/* Invite section */}
                <div className="md:col-span-7 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-[32px] p-8 shadow-2xl relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-40 bg-purple-500/5 rounded-full blur-[100px] -mr-20 -mt-20 transition-colors duration-700"></div>
                  <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500/30 to-transparent" />
                  
                  <h3 className="font-title text-3xl font-bold mb-3 text-white relative tracking-tight">{t('referrals.shareCode', 'Comparte tu código')}</h3>
                  <p className="font-body text-base text-slate-400 mb-8 relative">
                ...
                <div className="md:col-span-5 grid grid-cols-2 gap-4">
                  <div className="col-span-2 bg-gradient-to-br from-purple-900/20 to-fuchsia-900/10 rounded-3xl p-6 border border-white/10 shadow-xl flex flex-col justify-center transition-transform hover:scale-[1.02]">
                  ...
                  <div className="bg-white/[0.04] backdrop-blur-sm rounded-3xl p-6 border border-white/5 shadow-lg flex flex-col justify-center">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex-1 bg-white/[0.04] backdrop-blur-sm rounded-2xl px-5 py-4 border border-white/5 shadow-lg flex items-center justify-between">
              ...
              <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl relative">
                <div className="px-8 py-7 border-b border-white/10 flex items-center justify-between relative z-10">
                  ...
                  <span className="font-title text-[10px] uppercase tracking-[0.2em] text-white/50 bg-white/5 px-4 py-1.5 rounded-full border border-white/10 font-bold">
                    {t('referrals.list.total', 'Total:')} {listData?.total || 0}
                  </span>
                </div>

                {referrals.length === 0 ? (
                  <div className="py-24 flex flex-col items-center justify-center text-center px-4 relative z-10">
                    <div className="h-20 w-20 bg-purple-500/10 rounded-full flex items-center justify-center mb-6 border border-purple-500/20">
                      <Share2 className="h-8 w-8 text-purple-400/50" />
                    </div>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm text-left whitespace-nowrap">
                        ...
                        <tbody className="divide-y divide-white/5 relative">
                          {listFetching && (
                            <tr className="absolute inset-0 bg-black/20 backdrop-blur-sm z-10"></tr>
                          )}
                          {referrals.map((ref) => (
