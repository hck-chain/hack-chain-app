    ...
    <>
      ...
      <div className="relative z-0 min-h-screen flex flex-col overflow-x-hidden font-lato pt-16">
        ...
        <div className={`z-40 w-full border-b border-white/10 fixed top-0 left-0 right-0 bg-[#0B0B0F]/80 backdrop-blur transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`} style={{ minHeight: '56px' }}>
          ...
          <div
            className={`md:hidden overflow-y-auto w-full bg-[#0B0B0F] border-b border-white/10 transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-[calc(100vh-5rem)] opacity-100 py-4' : 'max-h-0 opacity-0 pointer-events-none py-0'
              }`}
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <CardHeader className="space-y-4 text-center">
                  <div
                    className="w-16 h-16 mx-auto rounded-xl bg-pink-400 flex items-center justify-center transition-all duration-300 md:group-hover:shadow-[0_0_22px_rgba(236,72,153,0.5)] breathing-icon"
                  >
                    <img
                      src="/icons/talent.avif"
                      alt="Talent"
              ...
              >
                <CardHeader className="space-y-4 text-center">
                  <div
                    className="w-16 h-16 mx-auto rounded-xl bg-blue-400 flex items-center justify-center transition-all duration-300 md:group-hover:shadow-[0_0_22px_rgba(59,130,246,0.5)] breathing-icon"
                  >
                    <img
                      src="/icons/libro.avif"
                      alt="Educator"
                      className="h-12 w-12 object-contain"
                    />
                  </div>
              ...
              >
                <CardHeader className="space-y-4 text-center">
                  <div
                    className="w-16 h-16 mx-auto rounded-xl bg-green-400 flex items-center justify-center transition-all duration-300 md:group-hover:shadow-[0_0_22px_rgba(34,197,94,0.5)] breathing-icon"
                  >
                    <img
                      src="/icons/maletin.avif"
                      alt="Recruiter"
                      className="h-12 w-12 object-contain"
                    />
                  </div>
